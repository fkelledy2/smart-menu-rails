  ...
  task verify: :environment do
    ...
    view_files.each do |file|
      ...
      content.each_line do |line|
        remaining_count += 1 if line.match(/style\s*=\s*['"][^'"]*['"]/)
      end
    end
    ...
    app_scss = Rails.root.join('app/assets/stylesheets/application.bootstrap.scss')
    ...
    if total_issues == 0 && remaining_count < 250
