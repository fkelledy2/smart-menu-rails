...
namespace :query_cache do
  ...
  task stats: :environment do
    ...
    if stats[:total_requests].positive?
      puts "\n📈 Performance Impact:"
  ...
  task :warm_type, [:type] => :environment do |_t, args|
  ...
  task :clear_restaurant, [:restaurant_id] => :environment do |_t, args|
