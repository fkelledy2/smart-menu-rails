...
# Usage: heroku/production/setup.sh

APP_NAME="smart-menus"
REGION="eu"
STACK="heroku-22"

echo "==> Setting up Heroku Production Environment: ${APP_NAME}"
...
# Add-ons (Production uses higher tiers)
...
echo "==> Next steps:"
echo "    1. Set additional config vars (Stripe, Google Maps, Sentry, etc.)"
echo "    2. Configure custom domain"
echo "    3. Deploy: git push https://git.heroku.com/${APP_NAME}.git main"
echo "    4. Run migrations: heroku run rails db:migrate -a ${APP_NAME}"
echo "    5. Scale dynos as needed"
