...
# Update plan item limits for Staging environment
# Usage: heroku/staging/update_plan_item_limits.sh [--dry-run]
...
Updates plan item limits in Staging environment:
...
echo "==> Updating plan item limits for Staging"
