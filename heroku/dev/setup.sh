...
# Heroku Development Environment Setup
# Usage: heroku/dev/setup.sh

APP_NAME="smart-menus-dev"
REGION="eu"
STACK="heroku-22"

echo "==> Setting up Heroku Development Environment: ${APP_NAME}"
...
heroku addons:create heroku-postgresql:essential-0 -a "${APP_NAME}" || echo "PostgreSQL already exists"
