...
# Update plan item limits for Development environment
# Usage: heroku/dev/update_plan_item_limits.sh [--dry-run]
...
Updates plan item limits in Development environment:
...
echo "==> Updating plan item limits for Development"
