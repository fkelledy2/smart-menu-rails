...
module Api
  module V1
    module Partner
      ...
      # JWT-protected. Requires 'workforce:read' scope.
      class WorkforceController < Api::V1::BaseController
        before_action :set_restaurant
        before_action -> { enforce_scope!('workforce:read') }

        def workforce
          authorize @restaurant, :workforce?, policy_class: PartnerIntegrationPolicy
