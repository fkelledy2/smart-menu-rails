class TablesettingsController < ApplicationController
    ...
    if current_user
        ...
        respond_to do |format|
          if @tablesetting.save
            format.html { redirect_to edit_restaurant_path(id: @tablesetting.restaurant.id), notice: t('common.flash.created', resource: t('activerecord.models.tablesetting')) }
    ...
    if current_user
        respond_to do |format|
          if @tablesetting.update(tablesetting_params)
            format.html { redirect_to edit_restaurant_path(id: @tablesetting.restaurant.id), notice: t('common.flash.updated', resource: t('activerecord.models.tablesetting')) }
  ...
  def destroy
    if current_user
        ...
        respond_to do |format|
          format.html { redirect_to edit_restaurant_path(id: @tablesetting.restaurant.id), notice: t('common.flash.deleted', resource: t('activerecord.models.tablesetting')) }
