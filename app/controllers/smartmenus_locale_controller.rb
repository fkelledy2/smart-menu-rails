class SmartmenusLocaleController < ApplicationController
  ...
  def update
    ...
    html_updates = menuitems.to_h do |mi|
      [view_context.dom_id(mi),
       render_to_string(partial: 'smartmenus/showMenuitemHorizontal',
                        locals: { mi: mi, ordrparticipant: OpenStruct.new(preferredlocale: locale), menuparticipant: nil,
                                  menu: @smartmenu.menu, },),]
    end
