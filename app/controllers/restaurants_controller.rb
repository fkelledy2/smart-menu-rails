class RestaurantsController < ApplicationController
  ...
  private
    ...
    def restaurant_params
      params.require(:restaurant).permit(:name, :description, :address1, :address2, :state, :city, :postcode, :country, :image, :status, :capacity, :user_id, :displayImages, :allowOrdering, :inventoryTracking, :currency, :genid)
    end
end
