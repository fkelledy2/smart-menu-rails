document.addEventListener("turbo:load", () => {
    ...
    if ($("#restaurantTabs").is(':visible')) {
        ...
        var restaurantOpeningHourTable = new Tabulator("#restaurant-openinghour-table", {
          ...
          {title: 'Open From', field: 'starthour', mutator: (value, data) => String(data.starthour).padStart(2, '0') + ':' + String(data.startmin).padStart(2, '0'), hozAlign:"right", headerHozAlign:"right" },
          {title: 'Open To', field: 'endhour', mutator: (value, data) => String(data.endhour).padStart(2, '0') + ':' + String(data.endmin).padStart(2, '0'), hozAlign:"right", headerHozAlign:"right" },
          ...
          langs:{
            ...
            "en":{
                "columns":{
                    ...
                    "starthour":"Open From", //replace the title of column name with the value "Name"
                    "endhour":"Open To", //replace the title of column name with the value "Name"
