...
export class HeroCarousel {
  ...
  getDefaultCTAContent() {
    ...
    const cta1Body = this.container.dataset.cta1Body || 'Create beautiful digital menus and streamline ordering.';
    const cta2Title = this.container.dataset.cta2Title || 'Intelligent features';
    const cta2Body = this.container.dataset.cta2Body || 'Smart ordering, images, translations, availability and more.';
  ...
  startCarousel() {
    console.log('[HeroCarousel] Starting timers - Images:', this.options.imageInterval + 'ms, CTA:', this.options.ctaInterval + 'ms');
  ...
  updateCTAContent() {
    ...
    console.log('[HeroCarousel] Updating CTA to index', this.currentCtaIndex, ':', currentCTA.title);
