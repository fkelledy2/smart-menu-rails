...
export default class extends Controller {
  ...
  open(event) {
    ...
    this.pending = {
      ...
      initialUpdatedAt: parseInt(
        link.dataset.aiImageGeneratorInitialUpdatedAtParam || link.dataset.initialUpdatedAt || '0',
        10
      ),
      initialImageUrl: (
        link.dataset.aiImageGeneratorInitialImageUrlParam ||
        link.dataset.initialImageUrl ||
        ''
      ).toString(),
    };
