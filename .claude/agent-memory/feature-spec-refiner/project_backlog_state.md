...
description: Current state of the feature backlog after all March 2026 prioritisation passes — 38 ranked features total; thirteenth pass completed 2026-03-30 (5 new specs refined and ranked)
type: project
---
...
IQ-1: Naked Domain Canonical Strategy (S — Rack initializer + DNS + robots.txt; ship before public launch)
...
## Current Sprint Targets (next best actions as of 2026-03-30)
Pre-sprint: IQ-1 Naked Domain (afternoon's work)
...
Track E: #36 Smartmenu Preview Modes (S, quick win — 2–3 days)
...
36. Smartmenu Preview Modes (signed token, remove staff-mode-indicator) — S effort
...
## Key Pre-Development Gates (as of 2026-03-30)
...
- Smartmenu Preview Modes (#36): legacy `?view=staff` deprecation window length; ActionCable behaviour in customer preview Phase 2
