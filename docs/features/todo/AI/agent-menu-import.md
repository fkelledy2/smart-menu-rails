...
## Status
- Priority Rank: #16 (first individual agent to ship after framework)
- Category: Post-Launch — agent tier, Phase 1
- Effort: M
- Dependencies: Agent Framework (#15), existing `OcrMenuImport` / OCR infrastructure, DeepL integration, OpenAI API
