...
1. Captures speech audio and converts to text (native STT)
2. Sends transcript + context token to Rails
3. Rails interprets intent, validates, updates state, returns UI directives
