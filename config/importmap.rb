...
pin '@sentry/browser', to: 'https://cdn.jsdelivr.net/npm/@sentry/browser@8.0.0/+esm'
...
# Cache bust timestamp to force reload: 2026-03-28
pin 'application', to: 'application.js?v=20260328', preload: true
...
pin 'smartmenu_customer', to: 'smartmenu_customer.js?v=20250314', preload: false
