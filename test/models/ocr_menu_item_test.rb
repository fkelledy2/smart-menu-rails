...
class OcrMenuItemTest < ActiveSupport::TestCase
  ...
  test "should return dietary information" do
    @ocr_menu_item.dietary_restrictions = ["vegetarian", "vegan"]
  ...
  test "should return allergen information" do
    @ocr_menu_item.allergens = ["gluten", "dairy"]
  ...
  test "should create from data" do
    ...
    assert_difference 'OcrMenuItem.count', 1 do
      ...
      assert_equal ["shellfish", "gluten"], item.allergens
  ...
  test "should update from params" do
    ...
    assert_equal ["gluten", "garlic"], @ocr_menu_item.allergens
    assert_equal ["vegetarian", "vegan"], @ocr_menu_item.dietary_restrictions
  end
end
