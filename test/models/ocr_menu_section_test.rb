...
class OcrMenuSectionTest < ActiveSupport::TestCase
  ...
  test "should be orderable by position" do
    ...
    section1 = OcrMenuSection.create!(
      ocr_menu_import: @ocr_menu_import,
      name: "Desserts",
      position: 3
    )
    
    section2 = OcrMenuSection.create!(
      ocr_menu_import: @ocr_menu_import,
      name: "Mains",
      position: 2
    )
    
    section3 = OcrMenuSection.create!(
      ocr_menu_import: @ocr_menu_import,
      name: "Starters",
      position: 1
    )
    ...
    assert_equal ["Starters", "Mains", "Desserts"], 
  ...
  test "should create items from data" do
    ...
    assert_equal ["Bruschetta", "Calamari"], 
