...
class AnalyticsServiceTest < ActiveSupport::TestCase
  ...
  test 'should handle errors gracefully' do
    @mock_client.expect :track, -> { raise StandardError, 'Test error' }, [Hash]
  ...
  test 'should not track in test environment by default' do
    ...
    assert_not @service.send(:should_track?)
  ...
  test 'should handle page tracking errors gracefully' do
    @mock_client.expect :page, -> { raise StandardError, 'Page tracking error' }, [Hash]
  ...
  test 'should handle identify errors gracefully' do
    @mock_client.expect :identify, -> { raise StandardError, 'Identify error' }, [Hash]
  ...
  test 'should handle anonymous tracking errors gracefully' do
    @mock_client.expect :track, -> { raise StandardError, 'Anonymous tracking error' }, [Hash]
