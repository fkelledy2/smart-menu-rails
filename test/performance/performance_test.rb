...
class PerformanceTest < ActiveSupport::TestCase
  ...
  test 'advanced cache service handles errors gracefully' do
    ...
    assert_nothing_raised do
      AdvancedCacheService.invalidate_order_caches(999_999)
      AdvancedCacheService.invalidate_restaurant_caches(999_999)
      AdvancedCacheService.invalidate_user_caches(999_999, skip_restaurant_cascade: true)
    end
  end
