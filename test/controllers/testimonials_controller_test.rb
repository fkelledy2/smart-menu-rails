...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference("Testimonial.count") do
      post testimonials_url, params: { testimonial: { restaurant_id: @testimonial.restaurant_id, testimonial: @testimonial.testimonial, user_id: @testimonial.user_id } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { restaurant_id: @testimonial.restaurant_id, testimonial: @testimonial.testimonial, user_id: @testimonial.user_id } }
