...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should handle feature key uniqueness' do
    ...
    Feature.create!(key: 'unique_test', descriptionKey: 'Unique Test')
  ...
  test 'should handle feature categorization' do
    ...
    categories = %w[basic premium enterprise addon]
  ...
  test 'should handle special characters in feature keys' do
    special_keys = %w[feature_with_underscore feature-with-dash feature123]
  ...
  test 'should handle feature comparison scenarios' do
    ...
    get features_path
    assert_response_in %i[success not_acceptable]
  end
  ...
  test 'should handle feature discovery scenarios' do
    ...
    Feature.where(key: discovery_features.map { |f| f[:key] }).find_each do |feature|
      get feature_path(feature)
      assert_response_in %i[success not_acceptable]
    end
  end
