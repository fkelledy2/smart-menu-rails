...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "feature ordering works" do
    ...
    feature_a = Feature.create!(key: 'a_feature', descriptionKey: 'A Feature')
    feature_z = Feature.create!(key: 'z_feature', descriptionKey: 'Z Feature')
    
    ordered_features = Feature.all.order(:key)
