...
class InventoriesTest < ApplicationSystemTestCase
  ...
  test 'should create inventory' do
    ...
    fill_in 'Currentinventory', with: @inventory.currentinventory
    fill_in 'Menuitem', with: @inventory.menuitem_id
    fill_in 'Resethour', with: @inventory.resethour
    fill_in 'Startinginventory', with: @inventory.startinginventory
