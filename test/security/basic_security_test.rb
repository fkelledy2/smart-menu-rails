...
class BasicSecurityTest < ActionDispatch::IntegrationTest
  ...
  test "should include CSRF protection in forms" do
    ...
    assert ApplicationController.respond_to?(:protect_from_forgery), "ApplicationController should have CSRF protection configured"
  ...
  test "should enforce business rules" do
    ...
    valid_restaurant_count = Restaurant.count
    post restaurants_path, params: {
      restaurant: {
