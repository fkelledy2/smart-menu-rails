...
class EmployeePolicyTest < ActiveSupport::TestCase
  ...
  test "should prevent unauthorized access across restaurant boundaries" do
    ...
    employee_a = Employee.create!(name: 'Employee A', eid: 'EMPA', role: :staff, status: :active, user: @user, restaurant: restaurant_a)
    employee_b = Employee.create!(name: 'Employee B', eid: 'EMPB', role: :staff, status: :active, user: @other_user, restaurant: restaurant_b)
