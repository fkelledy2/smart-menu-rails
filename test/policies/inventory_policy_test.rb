...
class InventoryPolicyTest < ActiveSupport::TestCase
  ...
  test 'should prevent unauthorized access across restaurant boundaries' do
    ...
    item_a = Menuitem.create!(name: 'Item A', menusection: section_a, price: 10.99, preptime: 15, calories: 300,
                              itemtype: :food, status: :active,)
    item_b = Menuitem.create!(name: 'Item B', menusection: section_b, price: 12.99, preptime: 20, calories: 400,
                              itemtype: :food, status: :active,)

    inventory_a = Inventory.create!(menuitem: item_a, startinginventory: 100, currentinventory: 85, resethour: 6,
                                    status: :active,)
    inventory_b = Inventory.create!(menuitem: item_b, startinginventory: 75, currentinventory: 60, resethour: 8,
                                    status: :active,)
