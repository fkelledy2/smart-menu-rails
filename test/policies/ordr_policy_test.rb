...
class OrdrPolicyTest < ActiveSupport::TestCase
  def setup
    ...
    @other_ordr = Ordr.create!(
      ...
      menu: @other_restaurant.menus.first || Menu.create!(name: 'Test Menu', restaurant: @other_restaurant,
                                                          status: :active,),
      tablesetting: @other_restaurant.tablesettings.first || Tablesetting.create!(name: 'Test Table',
                                                                                  restaurant: @other_restaurant, capacity: 4, tabletype: :indoor, status: :free,),
