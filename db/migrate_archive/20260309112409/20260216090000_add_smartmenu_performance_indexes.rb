...
class AddSmartmenuPerformanceIndexes < ActiveRecord::Migration[7.2]
  ...
  def change
    ...
    add_index :ordrs, %i[menu_id tablesetting_id status],
    ...
    add_index :menuparticipants, %i[sessionid smartmenu_id],
    ...
    add_index :alcohol_order_events, %i[ordr_id age_check_acknowledged],
    ...
    add_index :ordractions, %i[ordrparticipant_id ordr_id action],
