...
BATCH_1 = %w[allergyns announcements contacts]
BATCH_2 = %w[dw_orders_mv features genimages home]
BATCH_3 = %w[ingredients metrics notifications ocr_menu_imports]
BATCH_4 = %w[onboarding payments plans sessions]
BATCH_5 = %w[sizes smartmenus tablesettings tags taxes testimonials tips tracks userplans]
